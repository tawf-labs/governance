# Tawf Labs Technical Charter

## 1. Mission

Tawf Labs builds the open infrastructure layer for Islamic economic principles on-chain. We create decentralized protocols that enable Muslims and faith-aligned users to participate in Web3 without compromising their values — replacing speculation with purpose, opacity with transparency, and exclusion with verified participation.
...
The primary decision-making body. All DID-verified community members may propose and vote on ecosystem matters. Voting is reputation-weighted, not token-weighted.
...
Critical protocol operations (deployment, upgrades, treasury management) require multi-signature approval from Core Maintainers. The multi-sig threshold is documented in the governance contracts.
...
All Tawf Labs repositories are licensed under the Apache License, Version 2.0, unless otherwise noted. Contributions are accepted under the same license. The Tawf name and logo are trademarks of Tawf Labs and may not be used without permission.
...
3. Community DAO vote — 67% supermajority required
4. Sharia Council review and approval
5. Updated charter published to this repository

## 9. Ratification

This charter was ratified on 31 May 2026 by Muhammad Zidan Fatonie, Founder of Tawf Labs, and is effective immediately for all Tawf Labs repositories and ecosystem participants.
